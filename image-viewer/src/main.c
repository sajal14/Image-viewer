...
create_window (void)
{
	...
	gtk_window_set_title(GTK_WINDOW(window),"my image viewer");

	vbox= gtk_vbox_new(TRUE,5);
	hbox=gtk_hbox_new(TRUE,5);
	
	button = gtk_button_new_with_label (_("click to open image"));
	...
	gtk_box_pack_start (GTK_BOX (hbox), rights, FALSE, FALSE, 0);
